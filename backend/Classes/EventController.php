<?php
    ...
    class EventController{
        public function __construct(private EventRepository $eventRepository,private AuthRepository $authRepository,private MailService $mailService){
            ...
            switch ($method) {
                ...
                case "PATCH"://edit event
                    ...
                    foreach ($emails as $email) {
                        $this->mailService->sendMail($user["email"], "There has been an update on this event {$data["nome_evento"]}", trim($email));
                    }
